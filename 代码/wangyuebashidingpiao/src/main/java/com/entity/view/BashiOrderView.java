...
public class BashiOrderView extends BashiOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String bashiOrderValue;
		/**
		* 支付类型的值
		*/
		private String bashiOrderPaymentValue;
	...
	public BashiOrderView() {

	}

	public BashiOrderView(BashiOrderEntity bashiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, bashiOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getBashiOrderValue() {
				return bashiOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setBashiOrderValue(String bashiOrderValue) {
				this.bashiOrderValue = bashiOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getBashiOrderPaymentValue() {
				return bashiOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setBashiOrderPaymentValue(String bashiOrderPaymentValue) {
				this.bashiOrderPaymentValue = bashiOrderPaymentValue;
			}
