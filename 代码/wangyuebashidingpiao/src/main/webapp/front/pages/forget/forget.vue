	...
	<view class="content">
			...
			<view class="forget-card"
				...
				<view class="forget-input forget-margin-b">
					<input v-model="username"
						:style='{"borderColor":"rgba(153, 0, 51, 1)","backgroundColor":"#fff","borderRadius":"0px","color":"rgba(84, 170, 111, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
		...
		<view class="forget-btn">
			<button class="landing"
				:style='{"borderColor":"#ccc","backgroundColor":"rgba(153, 0, 51, 1)","borderRadius":"8rpx","color":"rgba(255, 255, 255, 1)","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}'
