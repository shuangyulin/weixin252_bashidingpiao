    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="原因" prop="jifenjiluName">
                       <el-input v-model="ruleForm.jifenjiluName"
                                 placeholder="原因" clearable  :readonly="ro.jifenjiluName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="原因" prop="jifenjiluName">
                           <el-input v-model="ruleForm.jifenjiluName"
                                     placeholder="原因" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="积分数量" prop="jifenjiluNumber">
                       <el-input v-model="ruleForm.jifenjiluNumber"
                                 placeholder="积分数量" clearable  :readonly="ro.jifenjiluNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="积分数量" prop="jifenjiluNumber">
                           <el-input v-model="ruleForm.jifenjiluNumber"
                                     placeholder="积分数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="jifenTypes">
                        <el-select v-model="ruleForm.jifenTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in jifenTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="jifenValue">
                        <el-input v-model="ruleForm.jifenValue"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jifen_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jifenTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='jifenjiluName'){
                          this.ruleForm.jifenjiluName = obj[o];
                          this.ro.jifenjiluName = true;
                          continue;
                      }
                      if(o=='jifenjiluNumber'){
                          this.ruleForm.jifenjiluNumber = obj[o];
                          this.ro.jifenjiluNumber = true;
                          continue;
                      }
                      if(o=='jifenTypes'){
                          this.ruleForm.jifenTypes = obj[o];
                          this.ro.jifenTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
